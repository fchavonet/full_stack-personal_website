...
<table align="center">
    ...
    <tr valign="top">
        <td align="center">
            <img width="100%" src="./v1.0/assets/images/screenshots/desktop_page_screenshot-light.webp" alt="v1.0 Screenshot">
        </td>
        <td align="center">
            <img width="100%" src="./v2.0/assets/images/screenshots/desktop_page_screenshot.webp" alt="v2.0 Screenshot">
        </td>
        <td align="center">
            <img width="100%" src="./v3.0/assets/images/screenshots/desktop_page_screenshot-light.webp" alt="v3.0 Screenshot">
        </td>
    </tr>
</table>
